...
ask_and_delete_databases() {
  local databases=(
    "$REPO_DIR/battmind_charging_history_db.yaml"
    "$REPO_DIR/battmind_drive_efficiency_db.yaml"
    "$REPO_DIR/battmind_error_log.yaml"
    "$REPO_DIR/battmind_kwh_avg_prices_db.yaml"
    "$REPO_DIR/battmind_power_values_db.yaml"
    "$REPO_DIR/battmind_solar_production_available_db.yaml"
  )
...
ask_and_delete_file "$REPO_DIR/packages/battmind.yaml" "Do you want to delete $REPO_DIR/packages/battmind.yaml and its entities?"
ask_and_delete_file "$REPO_DIR/battmind_config.yaml" "Do you want to delete $REPO_DIR/battmind_config.yaml and its configuration?"
...
echo -e "${YELLOW}  update_battmind: \"bash $REPO_DIR/scripts/update_battmind.sh\"${RESET}"
echo -e ""
